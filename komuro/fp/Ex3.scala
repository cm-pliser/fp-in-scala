object Ex3 {
    ...
    def main(args: Array[String]): Unit = {
        ...
        println("=========== 4.3 map2")
        // OKパティーン
        println(Option.map2[Int, Int, Int](Some(3), Some(2))((x, y) => x * y))
        // NGパティーン
        println(Option.map2[Int, Int, Int](None, Some(4))((x, y) => x + y))

        println("=========== 4.4 sequence")
        // OKパティーン
        println(Option.sequence(List(Some(1), Some(2), Some(3), Some(4))))
        // NGパティーン
        println(Option.sequence(List(None, Some(2), Some(3), Some(4))))
    }
}